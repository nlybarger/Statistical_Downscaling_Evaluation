...
def call_era5_centroids():
    regions, bukods = fdse.make_buko_region_map('1deg', COMPUTE=False)
    TimeStart = '1981-01-01'
    TimeEnd = '2016-12-31'
    nWTs = 6
...
def call_wtpr_cmip5():
    ...
    fwt.compute_wtpr_cmip5(regind, imod, TimeStart='1981-01-01', TimeEnd='2016-12-31', numWTs=6,OVERWRITE=True)
